...
public class Graph extends ImageView {
    ...
    public static final int DefaultBackgroundColor = Color.parseColor("#000000");
    public static final int DefaultForegroundColor = Color.parseColor("#FFFFFF");

    private static final int BOX_MINWIDTH_IN_DP = 300;
    private static final int BOX_MINHEIGHT_IN_DP = 300;
    ...
    private static int BackgroundColor = DefaultBackgroundColor;
    private static int ForegroundColor = DefaultForegroundColor;
    ...
    protected synchronized void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int desiredWidth = dpToPx(getContext(), BOX_MINWIDTH_IN_DP);
        int desiredHeight = dpToPx(getContext(), BOX_MINHEIGHT_IN_DP);
        ...
        mTextsize = dpToPx(getContext(), DefaultTextSize_IN_DP);
    ...
    private static int dpToPx(Context context, int dp) {
        ...
        scaleFactor = (displayMetrics.xdpi / DisplayMetrics.DENSITY_DEFAULT);
        int px = Math.round(dp * scaleFactor);
        return px;
    }
